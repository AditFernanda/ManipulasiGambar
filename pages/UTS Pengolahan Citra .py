...
def main():
    ...
    # Menentukan jalur file gambar lokal
    image_path = 'D:/Semester 4/UTS Pengolahan Citra/img/aditfernanda.jpg'

    try:
        # Membaca gambar dari jalur file lokal
        image = cv2.imread(image_path)
        if image is None:
            st.error("Error loading image. Make sure the image path is correct.")
            return
